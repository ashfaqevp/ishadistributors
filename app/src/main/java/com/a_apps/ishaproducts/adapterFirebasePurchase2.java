...
public class adapterFirebasePurchase2 extends FirebaseRecyclerAdapter<constructerShopReportPurchase, com.a_apps.ishaproducts.adapterFirebasePurchase2.purchaseViewholder> {

    public adapterFirebasePurchase2(
    ...
    @Override
    protected void
    onBindViewHolder(@NonNull com.a_apps.ishaproducts.adapterFirebasePurchase2.purchaseViewholder holder,
    ...
    @NonNull
    @Override
    public com.a_apps.ishaproducts.adapterFirebasePurchase2.purchaseViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_purchase, parent, false);
        return new com.a_apps.ishaproducts.adapterFirebasePurchase2.purchaseViewholder(view);
    }
